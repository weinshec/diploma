...
Extraktion des schwachen Mischungswinkels. Dessen Bestimmung findet weiterhin
in den Kanälen \ac{CC} und \ac{CF} getrennt statt, und wird erst am Ende zu
einem Gesamt-Ergebnis zusammengefasst. Der nun folgende Abschnitt beschreibt
zunächst die Methode, die zur Extraktion des Mischungswinkels aus den
Verteilungen der Asymmetrie verwendet wird.
