...
\begin{description}
    ...
    \cutitem{Spuren in Primärvertex}{Daten \& Simulation}{Ereignis-Kriterium}
        ...
        Primärvertex gestellt Ausgangspunkt mehr als 2 rekonstrukierter Spuren 
        zu sein. Dies dient der Diskriminierung des Beitrags hochenergetischer
        kosmischer Myonen an der Ereignisselektion.
        \newline\development (Korrektheit Prüfen)

    \cutitem{Pseudorapidität}{Daten \& Simulation}{Elektron-Schnitt}
        Dieser erste Schnitt auf die einzelnen Elektronkandidaten wird benutzt,
        um Ereignisse in zwei grundlegenden Klassen zu kategorisieren. Der für
        diese Arbeit interassante Endzustand besteht aus genau zwei Elektronen,
        sodass 
        Ereingisse mit Beteiligung

    \cutitem{Transversal-Impuls}{Daten \& Simulation}{Elektron-Schnitt}
