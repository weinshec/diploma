...
\cite{PhysRev.49.519}} für die Z-Re"-sonanz benutzt. Um die endliche Auflösung
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{plots/bad_fit_data_p40}
    \hfill
    \includegraphics[width=0.49\textwidth]{plots/bad_fit_mc_p40}
...
\begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{plots/still_bad_fit}
